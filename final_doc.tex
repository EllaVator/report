...
The result of this project was a interdisciplinary work with the faculty of informatics, phonology and computational linguistics, the outcome was an elevator that could not only be controlled haptically by pressing buttons, but also with voice command. \newline
...
For the project EllaVator a English as well as a German version of the system is provided.
...
Currently MBROLA is used in by Mary, which was selected as it creates a low distortion in the signal.
