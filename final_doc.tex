...
Keep in mind that ModuleElla has never been tested in conjunction with the rest of the system, so the implementation is more of a draft one. Basically the whole code was taken from OpenDial module examples and slightly modified to fit our purposes.
