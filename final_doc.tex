...
The JSGF uses the style and conventions of Java, as well as those of traditional grammar notations.\footnote{http://www.w3.org/TR/jsgf}
...
The grammar consists of two parts, the grammar header (lines 1 and ) and the grammar body (lines 3 to 67). 
